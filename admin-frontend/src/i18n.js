  ...
  en: {
    translation: {
      ...
      nav: {
        ...
        cambodianFix: 'Spot & Cambodian Fix (ខ្នាតជី)',
      ...
      cambodiaGold: {
        ...
        pricePerChi: 'Price per Chi (ជី)',
        pricePerDamlung: 'Price per Damlung (តម្លឹង)',
        ...
        unitLabel: 'Unit (ខ្នាត)',
        goldPurityLabel: 'Gold Purity (ទឹកមាស)',
        netGrams: 'Net Grams',
        inChi: 'In Chi (ជី)',
        inDamlung: 'In Damlung (តម្លឹង)',
      ...
      // Purities
      purity: {
        p24k: '24K Pure Bullion (មាសសុទ្ធ 99.9%)',
      ...
      pos: {
        ...
        creditCard: 'Credit Card (កាត)',
        khqr: 'KHQR / Bakong (បាគង)',
